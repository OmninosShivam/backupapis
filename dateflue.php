...
// 			}
  ...
  public function giftHistoryCalculation(){
    ...
    public function orderIdGenerate(){ // dateFlu Api.
...
//  print_r($finalLikeDisLike);
  ...
  public function getUserLevels(){// dateFlue
  ...
  public function getUserTalentLevels(){// date flue
...
// 	}
  ...
  public function addToCart(){
      ...
      public function getCart(){
        ...
        $getDetails = $this->db->select("addToCart.id addToCartId,addToCart.userId,addToCart.productId,addProducts.id addProductsId,addProducts.catId,addProducts.product_name,addProducts.coins,addProducts.specification,addProducts.description,users.username")
        ->from("addToCart")
...
public function getVideo(){
	...
	public function getReceiverEndTotalGifting(){ // dateFlu Api.
